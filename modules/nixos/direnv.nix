# FIXME: replace with NixOS module when 23.11 rolls out
# from: https://github.com/NixOS/nixpkgs/blob/194a3a7d97d3d533e9ce52df77b0673d75bfe07f/nixos/modules/programs/direnv.nix
{ config, lib, pkgs, ... }:
let
